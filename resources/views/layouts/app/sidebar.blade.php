...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            <flux:sidebar.header>
                <x-comp::app-logo :sidebar="true" href="{{ route('dashboard') }}" wire:navigate />
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.item icon="inbox" :href="route('quotations.index')" :current="request()->routeIs('quotations.*')" wire:navigate>
                        {{ __('Quotations') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
            ...
            <!-- <x-comp::desktop-user-menu class="hidden lg:block" :name="auth()->user()->name" /> -->
        </flux:sidebar>
